...
const SYSTEM_PROMPT = `Вы — опытный врач-менеджер партнерской программы DocDocPartner. Ваша роль:
...
**Ваша задача:**
1. Объяснить, как работает DocDocPartner простым языком
...
export default function DoctorChatbot() {
  ...
  const [messages, setMessages] = useState<Message[]>([
    {
      role: "assistant",
      content: "Здравствуйте! Я — менеджер программы DocDocPartner. Помогу разобраться, как врачи зарабатывают до 10% легально, рекомендуя пациентов в проверенные клиники. Что вас интересует?",
    },
  ]);
        ...
        <Card className="fixed bottom-6 right-6 z-50 w-[400px] max-w-[calc(100vw-3rem)] shadow-2xl">
          <div className="flex items-center justify-between p-4 border-b bg-primary text-primary-foreground">
            <div className="flex items-center gap-3">
              ...
              <div>
                <div className="font-semibold">Консультант DocDocPartner</div>
