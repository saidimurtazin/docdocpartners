            ...
            <motion.div variants={fadeUp}>
              <Accordion type="multiple" className="space-y-3">
                ...
                <AccordionItem value="referral" className="border-2 rounded-xl px-6 data-[state=open]:border-primary/30 transition-colors">
                  ...
                  <AccordionContent className="text-muted-foreground leading-relaxed pb-5">
                    Да! За каждого приглашённого агента, который зарегистрируется по вашей ссылке и получит первую подтверждённую рекомендацию, вам начисляется бонус 1 000 руб. Бонус доступен для вывода после 5 ваших собственных оплаченных пациентов.
                  </AccordionContent>
                </AccordionItem>
              </Accordion>
            </motion.div>
